    ...
    def render(self, mode='human'):
        ...
        if self.render_geoms is None:
            ...
            if self.render_callback:
                self.render_callback(rendering, self.viewers, self.render_geoms, self.render_geoms_xform)
            else:
                print('use default mpe render!')
        ...
        if self.set_render_callback:
            results = self.set_render_callback(self.viewers,
                                               self.shared_viewer,
                                               self.render_geoms,
                                               self.render_geoms_xform,
                                               mode)
        else:
            print('use default mpe update render!')
            results = []
            for i in range(len(self.viewers)):
