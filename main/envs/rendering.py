...
from pyglet.gl.gl_compat import glPushMatrix, glTranslatef, glRotatef, glScalef, glPopMatrix, glColor4f, \
    GL_LINE_STIPPLE, glLineStipple, glBegin, glVertex3f, glEnd, GL_POLYGON, glVertex2f
...
try:
    ...
    print("HINT: you can install pyglet directly via 'pip install pyglet'. But if you really just want to install all Gym dependencies and not have to think about it, 'pip install -e .[all]' or 'pip install gym[all]' will do it.")
